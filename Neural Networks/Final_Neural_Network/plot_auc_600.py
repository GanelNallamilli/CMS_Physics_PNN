...
GluGluToRadionToHHTo2G2Tau_M_600_AUC_NN = pd.read_csv("GluGluToRadionToHHTo2G2Tau_M_600_AUC_NN.csv")
GluGluToRadionToHHTo2G2Tau_M_600_AUC_Threshold = pd.read_csv("GluGluToRadionToHHTo2G2Tau_M-600_AUC_Threshold.csv")

GluGluToRadionToHHTo2G2Tau_M_600_AUC_Threshold_np = (GluGluToRadionToHHTo2G2Tau_M_600_AUC_Threshold.iloc[0]).to_numpy()
GluGluToRadionToHHTo2G2Tau_M_600_AUC_NN_np = (GluGluToRadionToHHTo2G2Tau_M_600_AUC_NN.iloc[0]).to_numpy()

temp_dict = {'Features': feature_list, 'GluGluToRadionToHHTo2G2Tau_M_600_AUC_Threshold':GluGluToRadionToHHTo2G2Tau_M_600_AUC_Threshold_np,
             'GluGluToRadionToHHTo2G2Tau_M_600_AUC_NN':GluGluToRadionToHHTo2G2Tau_M_600_AUC_NN_np}
...
reorder_dict_df=temp_dict_df.sort_values(by=['GluGluToRadionToHHTo2G2Tau_M_600_AUC_Threshold'], ascending=False)
i=0
...
for columns in reorder_dict_df.columns:
    if i>0:            
        ...
        plt.title('Plot of features against their AUC scores (sorted by M=600 GeV)',fontsize=15)
