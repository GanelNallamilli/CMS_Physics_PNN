...
optimum_features_10 = pd.read_csv(f"optimium_features_v2_10.csv")
optimum_features_12 = pd.read_csv(f"optimium_features_v2_12.csv")
optimum_features_14 = pd.read_csv(f"optimium_features_v2_14.csv")
optimum_features_16 = pd.read_csv(f"optimium_features_v2_16.csv")
optimum_features_18 = pd.read_csv(f"optimium_features_v2_18.csv")
...
plt.grid()
plt.savefig(f'Neural Networks\Final_Neural_Network\Plots\optimium_features_all_lr_0.0001.png', format='png')
plt.show()
